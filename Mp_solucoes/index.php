...
<head>
	...
	<title>MP Soluções Agência de Marketing Digital | Salvador</title>
	<meta charset="utf-8">
...
<body>
	...
	<section class="descricao-mp">
		<div class="container">
		<p>Com anos de experiência em desenvolvimento web e automação de marketing, a <b>MP Soluções</b> traz soluções que ajudam o seu time a vender mais tanto em segmentos B2C quanto B2B.</p>
		</div>
	</section>

	<section class="descricao-mp2">
		<div class="container">
			...
			<img alt="Trabalho MP" title="Trabalho MP" src="images/mockup1.jpg" />
			<div class="clear"></div>
		</div>
	</section>

	<section class="descricao-mp3">
		<div class="container">
			<div class="box-depoimento">
				<p>“Temos a Gats Negocios como parceiro estratégico nos nossos planejamento em plataforma digital. Sempre nos trazendo soluções inovadoras e adequadas às nossas necessidades e dos nossos clientes. Super recomendo!“</p>
				<br/>
			...
			<div class="space-servico">
				...
				<img src="images/img6.jpg" />	
						<div class="box-servico-wraper">
							...
							<p>Precisa de ajuda e planejamento de marketing no seu negócio? Fale com a MP soluções, hoje mesmo, para
	...
	<footer>
		<div class="container">
			<div class="box-footer">
				<h2>Endereço</h2>
				<p>Rua Sampaio da Costa, 28 - Centro, Salvador/SC, 12055-660, Brasil</p>
			</div>
			<div class="box-footer">
				<h2>Telefone</h2>
				<p>(71)99909-8939</p>
